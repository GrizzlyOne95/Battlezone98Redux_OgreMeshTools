...
FILE_DESCRIPTION = "Battlezone Mesh Tools"
INTERNAL_NAME = "BZMeshTools"
ORIGINAL_FILENAME = "BZMeshTools.exe"
...
def main() -> None:
    ...
    parser.add_argument("--version", required=True, help="Release version, for example 1.2.3 or v1.2.3")
